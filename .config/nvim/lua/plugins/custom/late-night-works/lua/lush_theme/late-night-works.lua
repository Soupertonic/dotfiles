...
local theme = lush(function(injected_functions)
  ...
  return {
    Normal         { bg = hsl(0, 0, 9), fg = hsl(0, 0, 80) }, -- Normal text
    LineNr         { fg = hsl(0, 0, 20) }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    LineNrAbove    { fg = hsl(0, 0, 20) }, -- Line number for when the 'relativenumber' option is set, above the cursor line
    LineNrBelow    { fg = hsl(0, 0, 20) }, -- Line number for when the 'relativenumber' option is set, below the cursor line
    CursorLine     { bg = hsl(0, 0, 13) }, -- Screen-line at the cursor, when 'cursorline' is set. Low-priority if foreground (ctermfg OR guifg) is not set.
    CursorLineNr   { fg = hsl(0, 0, 50) }, -- Error messages on the command line
    StatusLine     { bg = hsl(250, 0, 11) }, -- Status line of current window
    ...
    Comment        { fg = hsl(0, 0, 30) }, -- Any comment
    ...
    sym"@variable"          { fg = hsl(0, 0, 80) }, -- Identifier
    -- sym"@type"              { }, -- Type
    ...
    htmlTitle { fg = hsl(0, 0, 80)  },
    htmlH1 { fg = hsl(0, 0, 80)  },
    htmlH2 { fg = hsl(0, 0, 80)  },
    htmlH3 { fg = hsl(0, 0, 80)  },
    htmlH4 { fg = hsl(0, 0, 80)  },
    htmlH5 { fg = hsl(0, 0, 80)  },
    htmlH6 { fg = hsl(0, 0, 80)  },
    ...
    sym"@lsp.type.property.java" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.parameter.java" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.variable.java" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.recordComponent.java" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.enumMember.java" { fg = hsl(0, 0, 80) },
    sym"@lsp.type.annotationMember.java" { fg = hsl(0, 0, 80) },
    ...
    sym"@lsp.type.namespace.java" { fg = hsl(0, 0, 80) },
    sym"@lsp.mod.importDeclaration.java" { fg = hsl(0, 0, 80) },
    ...
    typescriptProp { fg = hsl(0, 0, 80) },
    typescriptDOMFormProp { fg = hsl(0, 0, 80) },
    typescriptDOMDocProp { fg = hsl(0, 0, 80) },
    typescriptBOMLocationMethod { fg = hsl(0, 0, 80) },
    typescriptFileReaderProp { fg = hsl(0, 0, 80) },
    typescriptXHRProp { fg = hsl(0, 0, 80) },
    typescriptVariableDeclaration { fg = hsl(0, 0, 80) },
    typescriptOptionalMark { fg = hsl(0, 0, 80) },
    typescriptIdentifierName { fg = hsl(0, 0, 80) },
    ...
    sym"@lsp.type.property.typescript" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.parameter.typescript" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.variable.typescript" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.enumMember.typescript" { fg = hsl(0, 0, 80)  },
    sym"@lsp.mod.enumMember.typescript" { fg = hsl(0, 0, 80)  },
    ...
    javaScriptProp { fg = hsl(0, 0, 80) },
    javaScriptDOMFormProp { fg = hsl(0, 0, 80) },
    javaScriptDOMDocProp { fg = hsl(0, 0, 80) },
    javaScriptBOMLocationMethod { fg = hsl(0, 0, 80) },
    javaScriptFileReaderProp { fg = hsl(0, 0, 80) },
    javaScriptXHRProp { fg = hsl(0, 0, 80) },
    javaScriptVariableDeclaration { fg = hsl(0, 0, 80) },
    javaScriptOptionalMark { fg = hsl(0, 0, 80) },
    javaScriptIdentifierName { fg = hsl(0, 0, 80) },
    ...
    sym"@lsp.type.namespace.javascript" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.property.javascript" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.parameter.javascript" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.variable.javascript" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.enumMember.javascript" { fg = hsl(0, 0, 80)  },
    sym"@lsp.mod.enumMember.javascript" { fg = hsl(0, 0, 80)  },
    ...
    cssProp { fg = hsl(0, 0, 80) },
    cssCustomProp { fg = hsl(244, 45, 73) },
    cssMediaType { fg = hsl(0, 0, 80) },
    cssAttributeSelector { fg = hsl(0, 0, 80) },
    ...
    shVariable { fg = hsl(0, 0, 80) },
    shOption { fg = hsl(0, 0, 80) },
    ...
    sym"@lsp.type.property.c" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.variable.c" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.parameter.c" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.operator.c" { fg = hsl(0, 0, 80)  },
    ...
    sym"@lsp.type.property.cpp" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.variable.cpp" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.parameter.cpp" { fg = hsl(0, 0, 80)  },
    sym"@lsp.type.operator.cpp" { fg = hsl(0, 0, 80)  },
}
end)
